# katago-server documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = "katago-server"
copyright = """2019, Tycho Tatistcheff"""
...
htmlhelp_basename = "katago_serverdoc"
