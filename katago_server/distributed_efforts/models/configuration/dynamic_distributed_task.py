...
class DynamicDistributedTaskConfiguration(SingletonModel):
    ...
    probability_predefined_ranking_game = FloatField(_("probability of playing ranking game"), help_text=_("If random() < probability, it will play ranking game (if any), else will play either predefined game, or dynamic one"), default=0.5)
    probability_predefined_training_game = FloatField(_("probability of playing predefined game"), help_text=_("If random() < probability, it will play predefined game (if any), else will play dynamic one"), default=0.8)
