...
class NetworkAdmin(admin.ModelAdmin):
    list_display = ("id", "name", "created_at", "size", "log_gamma_upper_confidence", "log_gamma_lower_confidence", "ranking")
    list_filter = ("created_at", "network_size", "nb_parameters")
    ...
    fieldsets = (
        (None, {"fields": (("id", "name", "created_at"), "parent_network")}),
