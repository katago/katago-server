...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='traininggame',
            name='unpacked_file',
            field=models.FileField(max_length=200, storage=django.core.files.storage.FileSystemStorage(location='/data/games/training'), upload_to=katago_server.games.models.training_game.upload_unpacked_training_to, validators=[katago_server.contrib.validators.FileValidator(content_types=('application/zip',), max_size=314572800)], verbose_name='training data (npz)'),
        ),
    ]
