...
class NetworkQuerySet(QuerySet):
    ...
    def select_networks_for_run(
        self,
        run: Run,
        for_training_games=False,
        for_rating_games=False,
        network_delay=None,
    ):
    ...
    def select_most_recent(
        ...
        filtered = self.select_networks_for_run(
            run,
            for_training_games=for_training_games,
            for_rating_games=for_rating_games,
