...
urlpatterns = (
    ...
    + [
        ...
        # Networks ------------------------------------------------------------
        path("networks/", NetworksView.as_view(), {"run": None}, name="current_run_networks"),
        path("networks/<run>/", NetworksView.as_view(), name="networks"),
        # Games ---------------------------------------------------------------
        path("games/", GameNetworkGroupsView.as_view(), {"run": None}, name="current_run_game_network_groups"),
        ...
        path("contributions/<run>/", ContributionsByRunView.as_view(), name="contributions"),
        # **********************************************************
        ...
        path(
            "sgfplayer/training-games/<id>/", SgfDetailView.as_view(), {"kind": "training"}, name="sgfplayer_training"
        ),
        path("sgfplayer/rating-games/<id>/", SgfDetailView.as_view(), {"kind": "rating"}, name="sgfplayer_rating"),
    ]
